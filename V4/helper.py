...
if needCalcWeight:
#    calcPCA_weight.calcW(trainset,mode='HR',folder = 'MNIST_weight',weight_thresholds = [0,1e-04,1e-5])
    calcPCA_weight.calcW(trainset,mode='LR_scale_6_interpo',folder = 'MNIST_weight',weight_thresholds = [0,0,0])
...
forward_result=layerExtractor.forward(dataset=trainset,datasetName="training_MNIST"\
                                      ...
                                      folder = 'MNIST_weight',weight_thresholds = [0,0,0])
if testInverse:    
    result_back = layerExtractor.inverse(forward_result,mode='LR_scale_6_interpo',layer = 'L3',folder = 'MNIST_weight',weight_thresholds = [0,0,0])
...
#                                      folder = 'MNIST_weight',weight_thresholds = [0,1e-04,1e-5])
#if testInverse:    
#    result_back = layerExtractor.inverse(forward_result,mode='HR',layer = 'L3',folder = 'MNIST_weight',weight_thresholds = [0,1e-04,1e-5])
